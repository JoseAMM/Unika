                    ...
                    <table>
                        <tr>
                            ...
                            <td class="table__editar">
                                <a href="EditarOperacion/index.php?id=<?php echo $row['idTipo_Operacion']?>">
                            ...
                            <td class="table__editar">
                                ...
                                if($row['Activo'] == 1){
                                    ...
                                    ?>
                                    <a href="">
                                        <input type="hidden"  class="input-activar" name="Activo" value="<?php echo $row['idTipo_Operacion']?>">
                                ...
                                ?>
                                    <a href="">
                                        <input type="hidden"  class="input-desactivar" name="Activo" value="<?php echo $row['idTipo_Operacion']?>">
                            ...
                            <td class="table__editar">
                                        ...
                                        <input type="hidden"  class="input-borrar" onclick="preguntar(<?php echo $row['idTipo_Operacion']?>)" >
                                        <input type="button" class="input-borrar" alt="" onclick="preguntar(<?php echo $row['idTipo_Operacion']?>)">
                            </td>
                        </tr>
                    </table>
                </section>
