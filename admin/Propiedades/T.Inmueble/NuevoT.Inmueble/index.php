<?php
    ...
    if($_SERVER['REQUEST_METHOD'] === 'POST') {
        ...
        $queryNewTipoInmueble = "INSERT INTO tipo_inmueble (Nombre_Tipo_Inmueble, Activo) VALUES ('$TipoInmueble', '1')";

        $resultadoNewTipoInmueble = mysqli_query($db, $queryNewTipoInmueble);

        if($resultadoNewTipoInmueble) {
    ...
    <section class="main__menu--content">
        ...
        <form action="" method="POST">
            ...
            <label for="tipoInmueble">
                <span>Tipo deInmueble</span>
                <input type="text" id= "tipoInmueble" name="tipoInmueble" placeholder = "Tipo de Inmueble Name" required maxlength="50">
            </label>
