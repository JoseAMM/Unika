<?php
    ...
    $idTipo_Inmueble = $_GET['id'];
    $idTipo_Inmueble = filter_var($idTipo_Inmueble, FILTER_VALIDATE_INT);
    ...
    $queryInmueble = "SELECT * FROM tipo_inmueble WHERE idTipo_Inmueble = $idTipo_Inmueble";
    $resultadoInmueble = mysqli_query($db, $queryInmueble);
    $resultadoInmueble = mysqli_fetch_assoc($resultadoInmueble);
    $resultadoInmueble = $resultadoInmueble['Nombre_Tipo_Inmueble'];
    ...
    if($_SERVER['REQUEST_METHOD'] === 'POST') {
        ...
        $tipoInmueble = limpieza( mysqli_real_escape_string($db, $_POST['tipoInmueble']));

        $queryEditarInmueble = "UPDATE tipo_inmueble SET Nombre_Tipo_Inmueble = '$tipoInmueble' WHERE idTipo_Inmueble = $idTipo_Inmueble";

        $resultadoEditarInmueble = mysqli_query($db, $queryEditarInmueble);

        if($resultadoEditarInmueble) {
    ...
    <section class="main__menu--content">
        ...
        <form action="" method="POST">
            ...
            <label for="tipoInmueble">
                ...
                <input type="text"  value="<?php echo $resultadoInmueble?>" id= "tipoInmueble" name="tipoInmueble" placeholder = "Tipo de Inmueble Name" required maxlength="50">
            </label>
