...
require('../../../Reportes_PDF/fpdf.php');
    ...
    $pdf->Image('../Imagenes/inmueble_185foto1.jpg',10,45,150);
    ...
    $pdf->Write(1, utf8_decode('Comprar'));
    $pdf->SetY(170);
    $pdf->SetX(15);
    $pdf->SetFont('Arial','',28);
    $pdf->Write(1, utf8_decode('$'.'1,000'));
    $pdf->SetDrawColor(255,0,0);
    // Colores de los bordes, fondo y texto
    $pdf->SetFillColor(255,0,0);
    $pdf->SetY(142);
    ...
    $pdf->SetX(140);
    $pdf->SetFont('Arial','',13);
    $pdf->Write(1, utf8_decode('Arrendamiento'));
    $pdf->SetY(230);
    $pdf->SetX(117);
    $pdf->SetFont('Arial','B',13);
    ...
    $pdf->SetX(149);
    $pdf->SetFont('Arial','',13);
    $pdf->Write(1, utf8_decode('545').' m2');
    $pdf->SetTextColor(0,0,0);
    $pdf->SetY(192);
    $pdf->SetX(13);
    $pdf->SetFont('Arial','B',13);
    ...
    $pdf->SetX(33);
    $pdf->SetFont('Arial','',13);
    $pdf->Write(1, utf8_decode('San Pedro'));
    $pdf->SetY(202);
    $pdf->SetX(13);
    $pdf->SetFont('Arial','B',13);
    ...
    $pdf->SetX(47);
    $pdf->SetFont('Arial','',13);
    $pdf->Write(1, utf8_decode('14650'));
    $pdf->SetY(212);
    $pdf->SetX(13);
    $pdf->SetFont('Arial','',10);
    $pdf->MultiCell(90, 5,utf8_decode('lorem ipsum lorem ipsum lorfdsfsad gasd fgdsf gdfsg fdgsd gfdgsfgfd sgfdgfdgdf sgfdgdf gfdgf dgdfs gf dgfdsgfdsgfdsgfdsgfdsgkfdsngjkdfshgjkdfhgjkfdghjdfsghdsfjg'));
    $pdf->SetY(274);
    $pdf->SetX(13);
