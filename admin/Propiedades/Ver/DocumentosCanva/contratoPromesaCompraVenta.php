...
function ContratoPromesaCompraVenta(
    ...
    if (file_exists('../DocumentosFirmados/ContratoPromesaCompraVenta' . $idInmueble . '.pdf')) {
        unlink('../DocumentosFirmados/ContratoPromesaCompraVenta' . $idInmueble . '.pdf');
    }
    $pdf = new PDF();
...
Firmado, en la Ciudad de México a las XX:XX pm del día XXX 17 del mes de XXXXXX del año 20XX, en tres tantos.'), 0, 'FJ', false);
    ...
    $pdf->Link(35, 190, 46, 10, 'https://unikabienesraices.com/Canva/index.php?id=' . $idInmueble . '&document=' . $nombreDocumento);
    //$pdf->Link(35, 190, 46, 10, 'http://localhost:3000/Canva/index.php?id=' . $idInmueble . '&document=' . $nombreDocumento);
    $pdf->SetY(195);
    $pdf->SetX(37);
    ...
    //$pdf->Link(82, 200, 46, 10, 'http://localhost:3000/Canva/index.php?id=' . $idInmueble . '&document=' . $nombreDocumento);
    $pdf->SetY(195);
    $pdf->SetX(121);
    $pdf->SetTextColor(255, 255, 255);
    $pdf->SetFont('Bold', '', 10);
