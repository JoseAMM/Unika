<?php
    ...
    $idrol = $_GET['id'];
    $idrol = filter_var($idrol, FILTER_VALIDATE_INT);
    ...
    if($_SERVER['REQUEST_METHOD'] === 'POST') {
        ...
        $queryEditarRol = "UPDATE rol SET Nombre_rol = '$rol' WHERE idrol = $idrol";

        $resultadoEditarRol = mysqli_query($db, $queryEditarRol);

        if($resultadoEditarRol) {
...
<header class="header__propiedades">
    ...
    <section class="main__menu--content">
        ...
        <form action="" method="POST">
            ...
            <label for="rol">
                <span>Rol</span>
                <input type="text"  value="<?php echo $resultadoRol?>" id= "rol" name="rol" placeholder = "Rol Name" required maxlength="50">
            </label>
