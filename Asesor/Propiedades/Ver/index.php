                ...
                <form action="" method="POST">
                    ...
                    while ($row = mysqli_fetch_assoc($consultaFotos)) : ?>
                        <label for=" <?php echo 'foto' . $i ?>" class="normal">
                            ...
                            <p><img src="../../../admin/Propiedades/Imagenes/<?php echo $row['NombreFotos'] ?>" alt=""></p>
                        </label>
                    <?php $i++;
                    endwhile; ?>
                    ...
                    <label for="descargar" class="input__firma">
                        ...
                        <section class="contenedor__firma">
                            <section class="acciones__firma" id="acciones__firmaAceptacion">
                                ...
                                <a href="../../../admin/Propiedades/Ver/DocumentosFirmados/aceptacionSeguimientoCompraVenta<?php echo($idInmueble . '.pdf')?>" class="<?php echo $classDescargarAceptacionCompraVenta ?>" download>Descargar PDF firmado</a>
                            </section>
                        </section>
                    </label>
                    <label for="descargar" class="input__firma">
                        ...
                        <section class="contenedor__firma">
                            <section class="acciones__firma" id="acciones__firmaPrivacidad">
                                ...
                                <a href="../../../admin/Propiedades/Ver/DocumentosFirmados/AvisoPrivacidad<?php echo($idInmueble . '.pdf')?>" class="<?php echo $classDescargarPrivacidad ?>" download>Descargar PDF firmado</a>
                            </section>
                        </section>
                    </label>
                    <label for="descargar" class="input__firma">
                        ...
                        <section class="contenedor__firma">
                            <section class="acciones__firma" id="acciones__firmaDerechos">
                                ...
                                <a href="../../../admin/Propiedades/Ver/DocumentosFirmados/CartaDerechos<?php echo($idInmueble . '.pdf')?>" class="<?php echo $classDescargarDerechos ?>" download>Descargar PDF firmado</a>
                            </section>
                        </section>
                    </label>
                    <label for="descargar" class="input__firma">
                        ...
                        <section class="contenedor__firma">
                            <section class="acciones__firma" id="acciones__firmaPromesa">
                                ...
                                <a href="../../../admin/Propiedades/Ver/DocumentosFirmados/ContratoPromesaCompraVenta<?php echo($idInmueble . '.pdf')?>" class="<?php echo $classDescargarPromesa ?>" download>Descargar PDF firmado</a>
                            </section>
                        </section>
                    </label>
