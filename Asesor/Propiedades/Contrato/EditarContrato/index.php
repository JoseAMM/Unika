<?php
    ...
    $idTipo_Contrato = $_GET['id'];
    $idTipo_Contrato = filter_var($idTipo_Contrato, FILTER_VALIDATE_INT);
    ...
    $queryContrato = "SELECT * FROM tipo_contrato WHERE idTipo_Contrato = $idTipo_Contrato";
    $resultadoContrato = mysqli_query($db, $queryContrato);
    $resultadoContrato = mysqli_fetch_assoc($resultadoContrato);
    $resultadoContrato = $resultadoContrato['Nombre_Contrato'];
    ...
    if($_SERVER['REQUEST_METHOD'] === 'POST') {
        ...
        $queryEditarContrato = "UPDATE tipo_contrato SET Nombre_Contrato = '$contrato' WHERE idTipo_Contrato = $idTipo_Contrato";

        $resultadoEditarContrato = mysqli_query($db, $queryEditarContrato);

        if($resultadoEditarContrato) {
...
<header class="header__propiedades">
    ...
    <section class="main__menu--content">
        ...
        <form action="" method="POST">
            ...
            <label for="contrato">
                <span>Contrato</span>
                <input type="text"  value="<?php echo $resultadoContrato?>" id= "contrato" name="contrato" placeholder = "Contrato Name" required maxlength="50">
            </label>
