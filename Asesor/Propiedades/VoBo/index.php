...
INNER JOIN datos_basicos ON inmueble.idInmueble = datos_basicos.Inmueble_idInmueble WHERE VoBo = 0 ORDER BY idInmueble ASC";
        ...
        <section class="table__content">
            ...
            <table>
                <tr>
                    ...
                    <td ><img class="content__imagen" src="../../../admin/Propiedades/Imagenes/<?php  
