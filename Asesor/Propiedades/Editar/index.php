        ...
        <?php endforeach?>
            ...
            <form action="" method="POST" enctype="multipart/form-data">
                ...
                <label for="cp">
                    ...
                    <input type="text" id= "cp"  value="<?php echo $cp;  ?>" name="cp" placeholder = "cp" readonly max="7" required>
                ...
                <section class="select">
                    ...
                    <label for="precio">
                    <span>Precio*</span>
                    <input value="<?php echo $precio;  ?>" type="number" id= "precio" name="precio"  placeholder = "$0000"  min="1000"  maxlength="10">
                </label>
