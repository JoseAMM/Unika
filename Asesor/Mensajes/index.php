<?php
    ...
    $queryConsulta = "SELECT * FROM mensajeempleado WHERE Destinatario IN($idUsuarios, 0) ORDER BY idMensajeEmpleado DESC";
            ...
            <section class="main__table">
                ...
                <section class="table__buttons">
                    <div class="button__volver">
                        <a class="volver" href="../Propiedades/Listado/index.php">Volver</a>
                    </div>
                </section>
                    ...
                    <table>
                        <tr>
                            ...
                            <td class="table__editar">
                                <a href="VerMensaje/index.php?id=<?php echo $row['idMensajeEmpleado']?>">
