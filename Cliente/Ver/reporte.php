...
function pdf($idInmueble, $foto1, $operacion, $precio ,$inmueble, $disponible, $habitaciones, $estacionamiento, $contrato, $superficie_construccion, $superficie_terreno, $colonia, $codigoPostal, $otras, $download, $share, $print ){
