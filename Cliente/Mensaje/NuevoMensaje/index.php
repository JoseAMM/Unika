...
<header class="header__propiedades">
    ...
    <section class="main__menu--content">
        ...
        <form action="" method="POST">
            ...
            <section class="select">
                ...
                <select name="destinatario" id="" required >
                    ...
                    <?php while($row = mysqli_fetch_assoc($resultadoAsesor)) : ?>
                        <option value="<?php echo $row['idEmpleado']; ?>"><?php echo $row['Nombre_Apellido'];
                        if($row['Rol_idRol'] == 1){
                            echo " (Administrador)";
                        } else if($row['Rol_idRol'] == 2){
                            echo " (Asesor)";
                        }?></option>
                    <?php endwhile; ?>
                </select>
            ...
            <label for="mensaje">
                <span>Mensaje</span>
                <input type="text" id= "mensaje" name="mensaje" placeholder = "Mensaje" required maxlength="250">
            </label>
